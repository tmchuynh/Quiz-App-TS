...
export function createRegisterSection(): void {
    ...
    const checkbox = registerSection.querySelector(
...
export function clearErrorStyles(): void {
    const {
        firstName,
        lastName,
        email,
...
export async function validateRegistrationForm(): Promise<void> {
    const {
        firstName,
        lastName,
        email,
 ...
 */
export function updateRequirementItem( itemId: string, isValid: boolean ): void {
